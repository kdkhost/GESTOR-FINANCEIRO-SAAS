        ...
        return response()->json([
            ...
            'dados' => collect($p->items())->map(function (Fatura $f) use ($empresas) {
                return [
                    ...
                    'vencimento_em' => $f->vencimento_em ? $f->vencimento_em->format('d/m/Y H:i') : null,
                    'vencimento_em_formatado' => $f->vencimento_em ? $f->vencimento_em->format('d/m/Y H:i') : null,
                    'pago_em' => $f->pago_em ? $f->pago_em->format('d/m/Y H:i') : null,
                    'pago_em_formatado' => $f->pago_em ? $f->pago_em->format('d/m/Y H:i') : null,
                    'gateway' => $f->gateway,
